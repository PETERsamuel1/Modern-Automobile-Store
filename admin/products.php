      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center mb-4 content-between">
            <h1 class="h3 mb-0 text-gray-800 user_title">Products</h1>
            ...
            <div class="col-12">
              <div class="box">
                <div class="box-header with-border">
                  ...
                  <a  href="#" id="newprodbtn" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i> New</a>
                </div>
                  <div class="box-body">
                    <div class="container">
      				            ...
      				            <div class="table-title">
                                    ...
                                    <div class="col-sm-4">
                                      <div class="show-categories">
                                        <select class="productcategory"></select>
                                      </div>
                                    </div>
      				                    <div class="col-sm-4">
                                    <!--
