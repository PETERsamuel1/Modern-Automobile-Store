        ...
        <div class="container form-container">
            <div class="content-grid">
                ...
                <div class="content-bottom">
                    <form id="usersigninform" onsubmit="return false">
                        <div class="field-group">

                            <div class="content-input-field">
                                <small class="form-text text-muted" id="e_error"></small>
                                <input name="customerLoginemail" id="customerLoginemail" type="text" placeholder="Email Address">
                            </div>
                        </div>
                        <div class="field-group">
                            <div class="content-input-field">
                                <small class="form-text text-muted" id="p_error"></small>
                                <input name="customerLoginpassword" id="customerLoginpassword" type="Password" placeholder="Password">
                            </div>
                        </div>
                        <div class="content-input-field">
                        ...
                        <ul class="list-login">
                            ...
                            <li>
                                <a href="changepassword.php" class="text-right">Forgot password?</a>
                            </li>
